  ...
  return (
    <main className="mt-20">
      ...
      <div className=" text-sm font-medium tracking-wide space-y-3 text-gray-700 mt-5 text-center">
        <p>
          <span className=" text-black text-normal">TechCorner</span> is an
        ...
        <p>
          At TechCorner, we believe that the best way to learn is through
          ...
          your expertise, TechCorner is your go-to destination for all things
          programming.
        </p>
        <p>
